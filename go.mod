module github.com/litsea/go-example
...
require (
	...
	github.com/litsea/kit v0.1.4
	github.com/litsea/log-slog v0.2.7
	github.com/litsea/viper-aws v0.2.3
...
require (
	...
	github.com/litsea/sentry-slog v0.2.3 // indirect
