...
LDFLAGS += -X 'github.com/litsea/go-example/version.Version=$(VERSION)'
LDFLAGS += -X 'github.com/litsea/go-example/version.GitRev=$(GITREV)'
LDFLAGS += -X 'github.com/litsea/go-example/version.GitBranch=$(GITBRANCH)'
LDFLAGS += -X 'github.com/litsea/go-example/version.BuildDate=$(DATE)'
